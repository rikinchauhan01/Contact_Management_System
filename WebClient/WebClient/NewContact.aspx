<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NewContact.aspx.cs" Inherits="WebClient.NewContact" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin-top: 5%">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card"><div class="card-header text-center text-light font-weight-bold mb-4 bg-dark">
                New Contact
            </div>
                    <div class="card-body">
                        <div class="auto-form-wrapper">
                            <form runat="server">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="SubmitButton" CssClass="btn btn-dark submit-btn btn-block" Text="Create" runat="server" OnClick="SubmitButton_Click"></asp:Button>
                                </div>
                            </form>
                        </div>
